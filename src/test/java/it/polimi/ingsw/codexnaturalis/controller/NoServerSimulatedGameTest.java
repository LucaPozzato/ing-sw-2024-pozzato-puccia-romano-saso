...
import it.polimi.ingsw.codexnaturalis.controller.WaitPlayerState;
...
public class NoServerSimulatedGameTest {
    ...
    void NoServer() {
        ...
        // -> that in the absence of a socket server running the game manages the exception thrown without shutting down the match
