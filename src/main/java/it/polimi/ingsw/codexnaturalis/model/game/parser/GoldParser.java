...
public class GoldParser {
    ...
    /**
     * When this method is called goldDeck is generated extracting the information
     * needed from the JSON file.
     ...
     * #) the objects (feather, scroll, ink) which appear in the corners at "points
     * type" <br>
    ...
    public Stack<GoldCard> parse() {
        InputStreamReader input = new InputStreamReader(
                getClass().getResourceAsStream("/it/polimi/ingsw/codexnaturalis/JSON/goldDeck.json"));
